...
const DOCUMENTS_METADATA: DocumentMeta[] = [
  ...
  },
  {
    ...
    desc: "Hierarchical Navigable Small World index over local documents.",
    nliScore: "Calibrated 96%",
  },
  {
    title: "Local_Llama3_8B_Weights.txt",
    type: "WEIGHTS METADATA",
    chunks: 72,
    dim: "384-D",
    status: "QUANTIZED Q4_K_M",
    color: 0x10b981, // emerald
    colorHex: "#10b981",
    pos: new THREE.Vector3(5.2, -2.8, 2.6),
    desc: "Air-gapped 4-bit model parameters running strictly in RAM.",
